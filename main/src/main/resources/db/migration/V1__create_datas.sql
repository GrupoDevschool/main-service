...
Create table request(id INT PRIMARY KEY AUTO_INCREMENT, created_date DATE NULL, descrption VARCHAR(255) NULL, layer VARCHAR(255) NULL, `order` INT NULL, status BOOLEAN NOT NULL, updated_date DATE NULL, uri_homolog VARCHAR(255) NULL, uri_prod VARCHAR(255) NULL, event_id INT NULL, request_father_id INT NULL, CONSTRAINT FOREIGN KEY(event_id) REFERENCES event(id), CONSTRAINT FOREIGN KEY(request_father_id) REFERENCES request(id));
